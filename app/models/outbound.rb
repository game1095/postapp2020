class Outbound < ApplicationRecord
  ...
  def check
    ...
    if ems_mailcenter.include?(self.destination[0..1]) == true 
      if self.bags[0] != nil
        if ems_mailcenter.include?(self.bags[0].number[13..14]) == true
          return "black"
        else
         return "red"
        end
    ...
    if autthaya.include?(self.destination[0..1]) == true 
      if self.bags[0] != nil
        if autthaya.include?(self.bags[0].number[13..14]) == true
          return "black"
        else
         return "red"
        end
    ...
    if sriracha.include?(self.destination[0..1]) == true 
      if self.bags[0] != nil
        if sriracha.include?(self.bags[0].number[13..14]) == true
          return "black"
        else
         return "red"
        end
    ...
    if krabinburi.include?(self.destination[0..1]) == true 
      if self.bags[0] != nil
        if krabinburi.include?(self.bags[0].number[13..14]) == true
          return "black"
        else
         return "red"
        end
    ...
    if nakornratchasrima.include?(self.destination[0..1]) == true 
      if self.bags[0] != nil
        if nakornratchasrima.include?(self.bags[0].number[13..14]) == true
          return "black"
        else
         return "red"
        end
    ...
    if lamphun.include?(self.destination[0..1]) == true 
      if self.bags[0] != nil
        if lamphun.include?(self.bags[0].number[13..14]) == true
          return "black"
        else
         return "red"
        end
    ...
    if denchai.include?(self.destination[0..1] == true 
      if self.bags[0] != nil
        if denchai.include?(self.bags[0].number[13..14]) == true
          return "black"
        else
         return "red"
        end
    ...
    if ratchaburi.include?(self.destination[0..1]) == true 
      if self.bags[0] != nil
        if ratchaburi.include?(self.bags[0].number[13..14]) == true
          return "black"
        else
         return "red"
        end
